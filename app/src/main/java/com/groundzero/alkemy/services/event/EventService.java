package com.groundzero.alkemy.services.event;
...
import com.groundzero.alkemy.activity.eventService.EventServiceMenuActivity;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (mLiveCard == null) {
            ...
            mLiveCardView = new RemoteViews(getPackageName(),
                    R.layout.event_service_live_card);
            ...
            mLiveCardView.setTextViewText(R.id.main_service_title_text_view,
                    getString(R.string.live_card_title_event_service_running));

            // Set up the live card's action with a pending intent
            // to show a menu when tapped
            Intent menuIntent = new Intent(this, EventServiceMenuActivity.class);
            ...
            Config.scheduleAISeenServiceAlarms(mContext);
